...
class BaseTransformer(pl.LightningModule):
    ...
    # def optimizer_step(self, epoch, batch_idx, optimizer, optimizer_idx,  optimizer_closure=None, on_tpu=None, using_native_amp=None, using_lbfgs=None, second_order_closure=None):
    #     optimizer.step()
    #     optimizer.zero_grad()
...
#             'loss': self.loss.item(),
#             }, open('model-{}.pt'.format(trainer.current_epoch), 'wb'))   
